...
[Cloud Endpoints](https://cloud.google.com/endpoints) is a Google API management product that uses Service Infrastructure to manage APIs running on Google Cloud and external platforms.
...
---
#### Continue with [Cloud Endpoints Resources](/docs/endpoints/resources).