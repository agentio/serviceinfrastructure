...
[API management](/docs/glossary#api-management) is a thriving industry with many vendors, marketers, and definitions. Stepping back from the fray, from the perspective of an individual software developer we say that *API management addresses the common concerns that arise when developers make and use networked APIs*.
