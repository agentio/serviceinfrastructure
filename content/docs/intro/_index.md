...
**API management** is a thriving industry with many definitions. Here we take the perspective of a software developer, and say that API management addresses the common concerns that arise when developers make and use networked APIs.
